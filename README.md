...
> [!WARNING]
> This entire project, including its code and documentation, was generated by AI. It was
> created to solve a simple problem for its author and nothing else. It has not been
> independently audited or validated as a general-purpose product. This software sends
> low-level USB commands to camera hardware and can persist settings to the device. Review
> and understand the code before using it. You use it entirely at your own risk.
...
This project is released under the [MIT License](LICENSE) and is provided **as is**, without
warranty of any kind. The licence also preserves the attribution notice for the
reverse-engineering work documented by `cameractrls` and `kiyoproctrls`.
